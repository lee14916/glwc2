...
# input
inPath = '/p/scratch/pines/fpittler/run/nucleon_sigma_term/cA211a.53.24/NJN/run/'
outPath = './post_data/'
# patterns = ['dt10_protonup','dt10_protondn','dt12_protonup','dt12_protondn','dt14_protonup','dt14_protondn']
